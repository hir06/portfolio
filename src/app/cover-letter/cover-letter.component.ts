...
export class CoverLetterComponent implements OnInit {
  coverLetter= {
    ...
    "close": "As mentioned, I believe that my years of experience designing computer software, problem solving skills and my strong educational background can be an asset to your organization. I  would appreciate it if you would keep me in mind for future openings. Thank you for going through my profile. I look forward to speak with you. Please contact at (+91) 7022048293 or phiral246@gmail.com if you have any questions."
}
  constructor() { }
